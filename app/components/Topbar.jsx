...
const Topbar = () => {
  return (
    <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:1}} className="topbar z-20 border-b-[1px] grid grid-cols-3 gap-8 bg-[#E5EAEF]">
      ...
      <div className="max-md:flex max-xs:hidden hidden pl-10 items-center">
        <p className="text-typography tracking-tight leading-[1.75rem] text-[1.25rem] font-semibold">
          Dashboard
        </p>
      </div>
      ...
      <div className="flex flex-row gap-6 items-center justify-between  pr-10">
        ...
        <div className="flex flex-row gap-6 items-center">
          <div className="hidden xl:flex xl:opacity-100 opacity-0 transition-opacity duration-500 flex-row gap-2 items-center">
            ...
            <p
              className={`${inter.className} font-medium text-[0.875rem] leading-[1.375rem]`}
            >
              November 15, 2023
            </p>
          </div>
          <div>
            <div className="flex w-[40px] max-md:hidden h-[40px] p-[11px] justify-center items-center gap-[6px] border-[0.769px] border-[#dadddd] rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <div className="flex px-[8px] max-md:px-[4px] py-[6px] flex-shrink-0 justify-center items-center gap-[12px] border-[1px] rounded-full border-[#dadddd]">
            ...
            <div className="max-lg:hidden flex items-end flex-col">
              <div className="text-[16px] flex justify-center items-end">Oyeniyi Victor</div> <div className="text-[14px] text-[#787486]">iamgojosatoru@icloud.com</div>
            </div>
