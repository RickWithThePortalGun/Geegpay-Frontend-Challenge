      ...
      <div className="h-dvh flex flex-col justify-between bg-[#F7F8FA] dark:bg-[#262626] dark:border-none">
        <div className=" flex justify-center items-center flex-col gap-4 pt-[2rem]">
          ...
          <div className="pt-[40px] gap-[2rem] flex flex-col">
            ...
            <motion.div
              variants={fadeIn("down", "spring", 0.9, 1)}
              initial="hidden"
              whileInView="show"
              viewport={{ once: true }}
            ...
            <motion.div
              variants={fadeIn("down", "spring", 1.3, 1)}
              initial="hidden"
              whileInView="show"
              viewport={{ once: true }}
              className="w-full flex items-center justify-center"
          ...
          {theme == "light" ? (
            <>
              ...
              <motion.div
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="w-[2.875rem] h-[5.75rem] flex-shrink-0 bg-white rounded-full flex flex-col relative"
              >
            ...
            <>
              ...
              >
                ...
                <div className=" absolute bottom-2 right-[12px] flex-shrink-0 bg-transparent">
                  <svg
                    className=""
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
