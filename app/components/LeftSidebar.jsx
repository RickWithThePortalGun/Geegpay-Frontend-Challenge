...
const LeftSidebar = () => {
  ...
  useEffect(() => {
    gsap.to(svgRef.current, {
      ...
      ease: "power4.inOut", // Linear easing for constant speed
    });
  }, []);
  ...
  return (
    <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:1}}  className="max-lg:justify-between z-50 flex leftsidebar bg-white w-[80px] border-r-[#EBECF2] border-[1px]">
      <div className="h-dvh flex flex-col justify-between bg-[#F7F8FA]">
        <div className=" flex justify-center items-center flex-col gap-4 pt-[2rem]">
          ...
          <div className="pt-[40px] gap-[2rem] flex flex-col">
            <div className="w-full flex items-center justify-center ">
              <motion.svg variants={fadeIn("down","spring", 0.7,1)} initial="hidden" whileInView="show" viewport={{once:true}}
            ...
            <motion.div variants={fadeIn("down","spring", 0.9,1)} initial="hidden" whileInView="show" viewport={{once:true}}  className="w-full flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <motion.div variants={fadeIn("down","spring", 1.1,1)} initial="hidden" whileInView="show" viewport={{once:true}} className="w-full flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <motion.div variants={fadeIn("down","spring", 1.3,1)} initial="hidden" whileInView="show" viewport={{once:true}} className="w-full flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <motion.div variants={fadeIn("down","spring", 1.5,1)} initial="hidden" whileInView="show" viewport={{once:true}} className="w-full flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          <motion.div variants={fadeIn("up","spring", 1.7,1)} initial="hidden" whileInView="show" viewport={{once:true}} className="w-[2.875rem] h-[5.75rem] flex-shrink-0 bg-white rounded-full flex flex-col relative">
            <div className="w-[2.1rem] flex items-center justify-center rounded-full p-2 absolute left-1.5 top-2 flex-shrink-0 bg-[#34caa5]">
              <svg className=""
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
  ...
  <path d="M23.1567 16.3903C23.0357 16.271 22.8846 16.1867 22.7195 16.1466C22.5543 16.1065 22.3814 16.112 22.2192 16.1625C21.5901 16.3568 20.9351 16.4542 20.2767 16.4513C18.4926 16.4495 16.7821 15.7401 15.5205 14.4787C14.2589 13.2173 13.5493 11.5069 13.5473 9.72285C13.545 9.06465 13.643 8.40995 13.8379 7.78128C13.8888 7.61887 13.8945 7.44566 13.8544 7.28025C13.8144 7.11483 13.73 6.96344 13.6104 6.84232C13.4909 6.7212 13.3406 6.63492 13.1757 6.59273C13.0108 6.55055 12.8375 6.55404 12.6745 6.60285C11.2513 7.03321 9.96401 7.82507 8.9381 8.9012C7.91218 9.97733 7.18269 11.301 6.82077 12.7431C6.45885 14.1851 6.47687 15.6964 6.87306 17.1294C7.26925 18.5624 8.03008 19.8683 9.08136 20.9197C10.1326 21.9711 11.4385 22.732 12.8715 23.1283C14.3045 23.5247 15.8157 23.5428 17.2578 23.181C18.6999 22.8192 20.0236 22.0898 21.0999 21.064C22.1761 20.0382 22.9681 18.751 23.3985 17.3278C23.4473 17.1644 23.4506 16.9907 23.408 16.8255C23.3654 16.6603 23.2785 16.5098 23.1567 16.3903Z" fill="#B2ABAB"/>
        ...
        <div className="pt-[40px] gap-[1.5rem] flex flex-col">
          <div className="w-full flex items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <div className="w-full pb-[1rem] flex items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
